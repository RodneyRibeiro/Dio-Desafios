class Cliente:
    def __init__(self,endereco:str,conta:list):
        self._endereco = endereco
        self._conta=conta
    
    def pessoafisica(self,cpf,nome,data_nascimento):
        self._cpf = cpf
        self._nome = nome
...
class Conta:
    def __init__(self,saldo:float,numero_conta:int,agencia:str,cliente,historico):
        self._saldo = saldo
